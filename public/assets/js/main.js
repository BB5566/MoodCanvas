...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('diary-form')) {
        ...
        imageBtn.addEventListener('click', async (event) => {
            ...
            // 更新提示詞區域顯示正在生成
            document.getElementById('image-prompt').value = 'AI 正在為您生成提示詞...';
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // 更新提示詞文字區域
                    document.getElementById('image-prompt').value = data.prompt || '已生成圖片提示詞';
    ...
    window.addQuickDiary = function(day, month, year) {
        ...
        const mood = prompt(`為 ${dateStr} 快速記錄一個心情符號 (e.g., 😊, 😢, 🔥):`);
