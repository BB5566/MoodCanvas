    ...
    <form action="index.php?action=diary_store" method="POST" id="diary-form">
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="date" id="diary_date" name="diary_date" 
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" 
                   placeholder="今天過得如何？" maxlength="50">
        </div>
...
document.getElementById('diary-form').addEventListener('submit', function() {
    ...
    btn.disabled = true;
    btn.querySelector('.btn-text').textContent = '處理中...';
